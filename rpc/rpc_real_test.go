...
func TestErrLog(t *testing.T) {
	...
	//query transaction
	err = jrpcClient.Call("Turingchain.QueryTransaction", req, &testResult)
	assert.Nil(t, err)
...
func TestGetAllExecBalance(t *testing.T) {
	...
	err := jrpcClient.Call("Turingchain.GetAllExecBalance", req, &res)
	assert.Nil(t, err)
...
func TestExprieCreateNoBalanceTransaction(t *testing.T) {
	...
	var groupres string
	err = jrpcClient.Call("Turingchain.CreateNoBalanceTransaction", req2, &groupres)
	assert.Nil(t, err)
...
func TestExprieSignRawTx(t *testing.T) {
	...
	var groupres string
	err = jrpcClient.Call("Turingchain.CreateRawTxGroup", req2, &groupres)
	assert.Nil(t, err)
	...
	err = jrpcClient.Call("Turingchain.SignRawTx", req3, &signgrouptx)
	assert.Nil(t, err)
