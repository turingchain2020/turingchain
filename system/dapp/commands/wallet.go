...
func lock(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Turingchain.Lock", nil, &res)
	ctx.Run()
}
...
func unLock(cmd *cobra.Command, args []string) {
	...
	var res rpctypes.Reply
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Turingchain.UnLock", params, &res)
	ctx.Run()
}
...
func walletStatus(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Turingchain.GetWalletStatus", nil, &res)
	ctx.Run()
}
...
func setPwd(cmd *cobra.Command, args []string) {
	...
	var res rpctypes.Reply
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Turingchain.SetPasswd", params, &res)
	ctx.Run()
}
...
func walletListTxs(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Turingchain.WalletTxList", params, &res)
...
func mergeBalance(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Turingchain.MergeBalance", params, &res)
	ctx.Run()
}
...
func noBalanceTx(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Turingchain.CreateNoBalanceTransaction", params, nil)
...
func signRawTx(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Turingchain.SignRawTx", params, nil)
	ctx.RunWithoutMarshal()
}
...
func setFee(cmd *cobra.Command, args []string) {
	...
	var res rpctypes.Reply
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Turingchain.SetTxFee", params, &res)
	ctx.Run()
}
...
func addSendTxFlags(cmd *cobra.Command) {
	...
	cmd.Flags().StringP("token", "t", types.TRC, "token name. (TRC supported)")
}
