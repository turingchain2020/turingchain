...
func dumpKey(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Turingchain.DumpPrivkey", params, &res)
	ctx.Run()
}
...
func listAccount(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Turingchain.GetAccounts", nil, &res)
...
func balance(cmd *cobra.Command, args []string) {
	...
	if execer == "" && height == -1 {
		...
		ctx := jsonclient.NewRPCCtx(rpcLaddr, "Turingchain.GetAllExecBalance", req, &res)
...
func importKey(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Turingchain.ImportPrivkey", params, &res)
...
func createAccount(cmd *cobra.Command, args []string) {
	...
	var res types.WalletAccount
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Turingchain.NewAccount", params, &res)
...
func getAccount(cmd *cobra.Command, args []string) {
	...
	var res types.WalletAccount
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Turingchain.GetAccount", params, &res)
...
func setLabel(cmd *cobra.Command, args []string) {
	...
	var res types.WalletAccount
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Turingchain.SetLabl", params, &res)
	ctx.SetResultCb(parseSetLabelRes)
	ctx.Run()
}
...
func dumpKeys(cmd *cobra.Command, args []string) {
	...
	var res types.Reply
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Turingchain.DumpPrivkeysFile", params, &res)
	ctx.Run()
}
...
func importKeys(cmd *cobra.Command, args []string) {
	...
	var res types.Reply
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Turingchain.ImportPrivkeysFile", params, &res)
	ctx.Run()
}
