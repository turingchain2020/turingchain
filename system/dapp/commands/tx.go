...
func queryTxByAddr(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Turingchain.GetTxByAddr", params, &res)
	ctx.Run()
}
...
func queryTx(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Turingchain.QueryTransaction", params, &res)
...
func getTxsByHashes(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Turingchain.GetTxByHashes", params, &res)
...
func getTxHexByHash(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Turingchain.GetHexTxByHash", params, nil)
...
func decodeTx(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Turingchain.DecodeRawTransaction", params, &res)
...
func viewAddress(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Turingchain.GetAddrOverview", params, &res)
...
func reWriteRawTx(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Turingchain.ReWriteRawTx", params, nil)
	ctx.RunWithoutMarshal()
}
