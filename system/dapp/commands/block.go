...
import (
	...
	commandtypes "github.com/turingchain2020/turingchain/system/dapp/commands/types"
...
func blockBodyCmd(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Turingchain.GetBlocks", params, &res)
...
func blockHeightHash(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Turingchain.GetBlockHash", params, &res)
	ctx.Run()
}
...
func blockViewByHash(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Turingchain.GetBlockOverview", params, &res)
	ctx.Run()
}
...
func blockHeader(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Turingchain.GetHeaders", params, &res)
	ctx.Run()
}
...
func lastHeader(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Turingchain.GetLastHeader", nil, &res)
	ctx.Run()
}
...
func lastSequence(cmd *cobra.Command, args []string) {
	rpcLaddr, _ := cmd.Flags().GetString("rpc_laddr")
	var res int64
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Turingchain.GetLastBlockSequence", nil, &res)
	ctx.Run()
}
...
func getsequences(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Turingchain.GetBlockSequences", params, &res)
	//ctx.SetResultCb(parseBlockDetail)
	ctx.Run()
}
...
func getblockbyhashs(cmd *cobra.Command, args []string) {
	...
	var res rpctypes.BlockDetails
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Turingchain.GetBlockByHashes", params, &res)
...
func addPushSubscribe(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Turingchain.AddPushSubscribe", params, &res)
	ctx.Run()
}
...
func listPushes(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Turingchain.ListPushes", nil, &res)
	ctx.Run()
}
...
func getPushSeqLastNumCmd(cmd *cobra.Command, args []string) {
	...
	var res types.Int64
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Turingchain.GetPushSeqLastNum", params, &res)
	ctx.Run()
}
