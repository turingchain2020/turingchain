...
type Driver interface {
	...
	SetExecutorAPI(queueapi client.QueueProtocolAPI, turingchainapi types.TuringchainClient)
...
func (d *DriverBase) SetExecutorAPI(queueapi client.QueueProtocolAPI, turingchainapi types.TuringchainClient) {
	d.execapi = api.New(queueapi, turingchainapi)
}
...
func CheckAddress(cfg *types.TuringchainConfig, addr string, height int64) error {
