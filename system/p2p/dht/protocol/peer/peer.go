...
const (
	...
	peerInfoOld = "/turingchain/peerinfoReq/1.0.0"
	peerInfo    = "/turingchain/peer-info/1.0.0" //老版本
	// Deprecated: old version, use peerVersion instead
	peerVersionOld = "/turingchain/peerVersion/1.0.0"
	peerVersion    = "/turingchain/peer-version/1.0.0"
)
