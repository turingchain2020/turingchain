...
import (
	queue "github.com/turingchain2020/turingchain/queue"
...
func (_m *QueueProtocolAPI) GetConfig() *types.TuringchainConfig {
	ret := _m.Called()

	var r0 *types.TuringchainConfig
	if rf, ok := ret.Get(0).(func() *types.TuringchainConfig); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*types.TuringchainConfig)
		}
	}
