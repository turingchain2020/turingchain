...
var (
	configPath = flag.String("f", "../cmd/turingchain/turingchain.test.toml", "configfile")

	jrpcaddr = "localhost:9671"
	jrpcsite = "http://localhost:9671"
	grpcaddr = "localhost:9672"
	grpcsite = "localhost:9672"
)
...
func (mock *mockClient) GetConfig() *types.TuringchainConfig {
...
func (mock *mockSystem) startup(size int) client.QueueProtocolAPI {
	...
	q.SetConfig(types.NewTuringchainConfig(types.GetDefaultCfgstring()))
	queue := &mockQueue{q: q}
	chain := &mockBlockChain{}
