...
func testGetAccountsJSONRPC(t *testing.T, rpc *mockJRPCSystem) {
	...
	err := rpc.newRPCCtx("Turingchain.GetAccounts", &types.ReqNil{}, &res)
	if err != nil {
...
func testDumpPrivkeyJSONRPC(t *testing.T, rpc *mockJRPCSystem) {
	...
	err := rpc.newRPCCtx("Turingchain.DumpPrivkey", &types.ReqString{}, &res)
	if err != nil {
...
func testDumpPrivkeysFileJSONRPC(t *testing.T, rpc *mockJRPCSystem) {
	...
	err := rpc.newRPCCtx("Turingchain.DumpPrivkeysFile", &types.ReqPrivkeysFile{}, &res)
	if err != nil {
...
func testImportPrivkeysFileJSONRPC(t *testing.T, rpc *mockJRPCSystem) {
	var res rpctypes.Reply
	err := rpc.newRPCCtx("Turingchain.ImportPrivkeysFile", &types.ReqPrivkeysFile{}, &res)
	if err != nil {
...
func testGetWalletStatusJSONRPC(t *testing.T, rpc *mockJRPCSystem) {
	...
	err := rpc.newRPCCtx("Turingchain.GetWalletStatus", &types.ReqNil{}, &res)
	if err != nil {
...
func testGetNetInfoJSONRPC(t *testing.T, rpc *mockJRPCSystem) {
	...
	err := rpc.newRPCCtx("Turingchain.GetNetInfo",
...
func testIsSyncJSONRPC(t *testing.T, rpc *mockJRPCSystem) {
	var res bool
	err := rpc.newRPCCtx("Turingchain.IsSync",
		nil, &res)
	if err != nil {
...
func testIsNtpClockSyncJSONRPC(t *testing.T, rpc *mockJRPCSystem) {
	var res bool
	err := rpc.newRPCCtx("Turingchain.IsNtpClockSync",
		nil, &res)
	if err != nil {
...
func testGetPeerInfoJSONRPC(t *testing.T, rpc *mockJRPCSystem) {
	...
	err := rpc.newRPCCtx("Turingchain.GetPeerInfo",
...
func testGenSeedJSONRPC(t *testing.T, rpc *mockJRPCSystem) {
	...
	err := rpc.newRPCCtx("Turingchain.GenSeed",
		params, &res)
	if err != nil {
...
func testGetLastMemPoolJSONRPC(t *testing.T, rpc *mockJRPCSystem) {
	...
	err := rpc.newRPCCtx("Turingchain.GetLastMemPool",
		nil, &res)
	if err != nil {
...
func testGetProperFeeJSONRPC(t *testing.T, rpc *mockJRPCSystem) {
	...
	err := rpc.newRPCCtx("Turingchain.GetProperFee",
		nil, &res)
	if err != nil {
...
func testGetMempoolJSONRPC(t *testing.T, rpc *mockJRPCSystem) {
	var res rpctypes.ReplyTxList
	err := rpc.newRPCCtx("Turingchain.GetMempool",
		nil, &res)
	if err != nil {
...
func testGetLastHeaderJSONRPC(t *testing.T, rpc *mockJRPCSystem) {
	...
	err := rpc.newRPCCtx("Turingchain.GetLastHeader",
		nil, &res)
	if err != nil {
...
func testGetHeadersCmdJSONRPC(t *testing.T, rpc *mockJRPCSystem) {
	...
	err := rpc.newRPCCtx("Turingchain.GetHeaders",
		params, &res)
	if err != nil {
...
func testGetBlockOverviewJSONRPC(t *testing.T, rpc *mockJRPCSystem) {
	...
	err := rpc.newRPCCtx("Turingchain.GetBlockOverview",
		params, &res)
	if err != nil {
...
func testGetBlocksJSONRPC(t *testing.T, rpc *mockJRPCSystem) {
	...
	err := rpc.newRPCCtx("Turingchain.GetBlocks",
		params, &res)
	if err != nil {
...
func testGetBlockHashJSONRPC(t *testing.T, rpc *mockJRPCSystem) {
	...
	err := rpc.newRPCCtx("Turingchain.GetBlockHash",
		params, &res)
	if err != nil {
...
func testVersionGRPC(t *testing.T, rpc *mockGRPCSystem) {
	...
	assert.Equal(t, version.GetVersion(), res.Turingchain)
}
