...
var datadir = flag.String("datadir", "", "data dir of turingchain, include logs and datas")
var configPath = flag.String("f", "turingchain.toml", "configfile")
...
func initEnv() (queue.Queue, queue.Module, queue.Module) {
	cfg := types.NewTuringchainConfig(types.ReadFile(*configPath))
