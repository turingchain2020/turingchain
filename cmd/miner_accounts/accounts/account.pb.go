...
type MinerAccount struct {
	...
	MinerTrcDuring    string `protobuf:"bytes,6,opt,name=minerTrcDuring" json:"minerTrcDuring,omitempty"`
...
func (m *MinerAccount) GetMinerTrcDuring() string {
	if m != nil {
		return m.MinerTrcDuring
	}
	return ""
}
...
type Config struct {
	...
	TuringchainHost  string   `protobuf:"bytes,5,opt,name=turingchainhost" json:"turingchainhost,omitempty"`
}
...
func (m *Config) GetTuringchainHost() string {
	if m != nil {
		return m.TuringchainHost
	}
	return ""
}
