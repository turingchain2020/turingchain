...
func (b turingchain) findBlock(ts int64) (int64, *rpctypes.Header) {
...
func (b turingchain) getBalance(addrs []string, exec string, height int64) (*rpctypes.Header, []*rpctypes.Account, error) {
...
func (b turingchain) addBlock(h *rpctypes.Header) error {
...
func getLastHeader(cli *jsonclient.JSONClient) (*rpctypes.Header, error) {
	method := "Turingchain.GetLastHeader"
