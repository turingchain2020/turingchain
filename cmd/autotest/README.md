...
#### **通过turingchain makefile**
turingchain开发人员修改框架或dapp代码，验证测试
```

//启动单节点solo版本turingchain，运行默认配置autotest，dapp用于指定需要跑的配置用例
...
```
# 指定内部调用turingchain-cli程序文件
cliCmd = "./turingchain-cli"
...
# 测试用例配置文件，根据dapp分类
[[TestCaseFile]]
contract = "trc"    # coins合约
filename = "trc.toml" # 用例文件路径
...
### 扩展开发
分为以下几个步骤
> 注册dapp的AutoTest类型，以turingchain/system/dapp/coins为例
