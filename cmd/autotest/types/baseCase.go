...
import (
	...
	turingchainType "github.com/turingchain2020/turingchain/system/dapp/commands/types"
)
...
//check item handler
//适配autotest早期版本，handlerfunc的参数为json的map形式，后续统一使用turingchain的TxDetailResult结构体结构
...
func (pack *BaseCasePack) CheckResult(handlerMap interface{}) (bCheck bool, bSuccess bool) {
	...
	if bReady {
		...
		var txRecp turingchainType.TxDetailResult
		pack.TxReceipt = txInfo
