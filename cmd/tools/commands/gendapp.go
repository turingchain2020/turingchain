...
import (
	...
	"github.com/turingchain2020/turingchain/cmd/tools/strategy"
...
func addGenDappFlag(cmd *cobra.Command) {
	...
	cmd.Flags().StringP("output", "o", "", "go package for output (default github.com/turingchain2020/plugin/plugin/dapp/)")
