...
func main() {
	...
	cli.RunTuringchain("${PROJECTNAME}")
}
`
...
var ${PROJECTNAME} = `
	...
	// 生成项目运行主程序的模板 xxx.go
	// 顶部还需要加上package main
	//var turingchaincoin = `CPFT_RUNMAIN`
...
#系统中所有的fork,默认用turingchain的测试网络的
#但是我们可以替换
[fork.system]
ForkChainParamV1= 0
ForkCheckTxDup=0
...
`
	...
	CpftMakefile = `
TURINGCHAIN=github.com/turingchain2020/turingchain
TURINGCHAIN_PATH=vendor/${TURINGCHAIN}
...
update:
	...
	rm -rf ${TURINGCHAIN_PATH}
	git clone --depth 1 -b master https://${TURINGCHAIN}.git ${TURINGCHAIN_PATH}
	rm -rf vendor/${TURINGCHAIN}/.git
	rm -rf vendor/${TURINGCHAIN}/vendor/github.com/apache/thrift/tutorial/erl/
	cp -Rf vendor/${TURINGCHAIN}/vendor/* vendor/
	rm -rf vendor/${TURINGCHAIN}/vendor
	govendor init
	go build -i -o tool github.com/turingchain2020/plugin/vendor/github.com/turingchain2020/turingchain/cmd/tools
...
[dapp-ticket]
gitrepo = "github.com/turingchain2020/plugin/plugin/dapp/ticket"

[consensus-ticket]
gitrepo = "github.com/turingchain2020/plugin/plugin/consensus/ticket"

[dapp-retrieve]
gitrepo = "github.com/turingchain2020/plugin/plugin/dapp/retrieve"

[dapp-hashlock]
gitrepo = "github.com/turingchain2020/plugin/plugin/dapp/hashlock"

[dapp-token]
gitrepo = "github.com/turingchain2020/plugin/plugin/dapp/token"

[dapp-trade]
gitrepo = "github.com/turingchain2020/plugin/plugin/dapp/trade"

[mempool-price]
gitrepo = "github.com/turingchain2020/plugin/plugin/mempool/price"

[mempool-score]
gitrepo = "github.com/turingchain2020/plugin/plugin/mempool/score"
`
	// 项目 cli/main.go 文件模板
