...
import (
	...
	"github.com/turingchain2020/turingchain/cmd/tools/util"
)
...
func (ad *genDappStrategy) Run() error {
	fmt.Println("Begin generate turingchain dapp code.")
	defer fmt.Println("End generate turingchain dapp code.")
	if !ad.initMember() {
...
func (ad *genDappStrategy) initMember() bool {
	...
	if outDir == "" {
		outDir = filepath.Join("github.com", "turingchain2020", "plugin", "plugin", "dapp")
	}
	//兼容win 反斜杠路径
