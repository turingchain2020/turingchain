...
func (c *createPluginStrategy) Run() error {
	fmt.Println("Begin run turingchain create plugin project mode.")
	defer fmt.Println("Run turingchain create plugin project mode finish.")
...
func (c *createPluginStrategy) initMember() error {
	...
	c.gopath = gopath
	c.outRootPath = filepath.Join(gopath, "/src/github.com/turingchain2020")
