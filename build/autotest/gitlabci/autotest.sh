...
NODE3="autotest-turingchain"
CLI="docker exec ${NODE3} /root/turingchain-cli"

NODE2="autotest-chain32"
CLI2="docker exec ${NODE2} /root/turingchain-cli"
...
function init() {
    ...
    # p2p
    sed -i $sedfix 's/^seeds=.*/seeds=["turingchain:13802","chain32:13802"]/g' turingchain.toml
...
function stop_turingchain() {
    ...
    docker-compose -p "${PROJECT_NAME}" -f compose-autotest.yml down && rm -rf ./turingchain* ./*.toml ./autotest
