...
testtoml=turingchain.toml
# to close solo miner config in un-miner node
testtomlsolo=turingchain-solo.toml
...
function base_init() {
    ...
    # p2p
    sed -i $sedfix 's/^seeds=.*/seeds=["turingchain:13802","chain32:13802","chain31:13802"]/g' ${testtoml}
    ...
    # rpc
    sed -i $sedfix 's/^jrpcBindAddr=.*/jrpcBindAddr="0.0.0.0:9671"/g' ${testtoml}
    sed -i $sedfix 's/^grpcBindAddr=.*/grpcBindAddr="0.0.0.0:9672"/g' ${testtoml}
