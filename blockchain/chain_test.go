...
func addTx(cfg *types.TuringchainConfig, priv crypto.PrivKey, api client.QueueProtocolAPI) ([]*types.Transaction, string, error) {
...
func addTxTxHeight(cfg *types.TuringchainConfig, priv crypto.PrivKey, api client.QueueProtocolAPI, height int64) ([]*types.Transaction, string, error) {
...
func testGetChunkRecordMsg(t *testing.T, mock33 *testnode.TuringchainMock, blockchain *blockchain.BlockChain) {
...
func testAddChunkRecordMsg(t *testing.T, mock33 *testnode.TuringchainMock, chain *blockchain.BlockChain) {
...
func testGetChunkBlockBodyMsg(t *testing.T, mock33 *testnode.TuringchainMock, blockchain *blockchain.BlockChain) {
...
func testAddChunkBlockMsg(t *testing.T, mock33 *testnode.TuringchainMock, blockchain *blockchain.BlockChain) {
...
func testProcAddBlockMsg(t *testing.T, mock33 *testnode.TuringchainMock, blockchain *blockchain.BlockChain) {
...
func testProcQueryTxMsg(cfg *types.TuringchainConfig, t *testing.T, blockchain *blockchain.BlockChain) {
...
func testGetBlockByHash(t *testing.T, cfg *types.TuringchainConfig, blockchain *blockchain.BlockChain) {
...
func testGetBlockByHashes(t *testing.T, cfg *types.TuringchainConfig, blockchain *blockchain.BlockChain) {
...
func testPrefixCount(t *testing.T, mock33 *testnode.TuringchainMock, blockchain *blockchain.BlockChain) {
...
func testAddrTxCount(t *testing.T, mock33 *testnode.TuringchainMock, blockchain *blockchain.BlockChain) {
...
func testGetBlockHerderByHash(t *testing.T, cfg *types.TuringchainConfig, blockchain *blockchain.BlockChain) {
...
func textProcGetBlockOverview(t *testing.T, cfg *types.TuringchainConfig, blockchain *blockchain.BlockChain) {
...
func testProcGetAddrOverview(t *testing.T, cfg *types.TuringchainConfig, blockchain *blockchain.BlockChain) {
...
func testProcGetBlockHash(t *testing.T, cfg *types.TuringchainConfig, blockchain *blockchain.BlockChain) {
...
func testGetOrphanRoot(t *testing.T, cfg *types.TuringchainConfig, blockchain *blockchain.BlockChain) {
...
func testRemoveOrphanBlock(t *testing.T, cfg *types.TuringchainConfig, blockchain *blockchain.BlockChain) {
...
func testProcDelParaChainBlockMsg(t *testing.T, mock33 *testnode.TuringchainMock, blockchain *blockchain.BlockChain) {
...
func testProcAddParaChainBlockMsg(t *testing.T, mock33 *testnode.TuringchainMock, blockchain *blockchain.BlockChain) {
...
func testProcGetBlockBySeqMsg(t *testing.T, mock33 *testnode.TuringchainMock, blockchain *blockchain.BlockChain) {
...
func testProcDelChainBlockMsg(t *testing.T, mock33 *testnode.TuringchainMock, blockchain *blockchain.BlockChain) {
...
func testFaultPeer(t *testing.T, cfg *types.TuringchainConfig, chain *blockchain.BlockChain) {
...
func testCheckBestChainProc(t *testing.T, cfg *types.TuringchainConfig, blockchain *blockchain.BlockChain) {
...
func testCmpBestBlock(t *testing.T, client queue.Client, block *types.Block, cfg *types.TuringchainConfig) {
