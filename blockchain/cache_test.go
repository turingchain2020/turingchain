...
func initTxHashCache(txHeightRange int64) (*txHashCache, *BlockChain, *types.TuringchainConfig) {
	cfg := types.NewTuringchainConfig(types.GetDefaultCfgstring())
...
func newTestTxs(cfg *types.TuringchainConfig, priv crypto.PrivKey, currHeight, txHeightRange int64) []*types.Transaction {
...
func addTestBlock(chain *BlockChain, cfg *types.TuringchainConfig, priv crypto.PrivKey, startHeight, txHeightRange int64, blockNum int) {
