...
import (
	...
	"github.com/turingchain2020/turingchain/executor/authority"
	"github.com/turingchain2020/turingchain/executor/authority/utils"
	...
	secp256r1_util "github.com/turingchain2020/turingchain/system/crypto/secp256r1"
...
func initEnv() (*types.TuringchainConfig, error) {
	cfg := types.NewTuringchainConfig(types.ReadFile("./turingchain.auth.test.toml"))
