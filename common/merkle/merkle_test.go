...
func TestCalcMainMerkleRoot(t *testing.T) {
	...
	oldMixTuringHash := calcSingleLayerMerkleRoot(sorTxList[9:13])
	mixChainHashes = append(mixChainHashes, oldMixTuringHash)
	...
	assert.Equal(t, childMixChainHash[1].ChildHash, oldMixTuringHash)
