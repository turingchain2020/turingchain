...
// Hash 获取block的hash值
func (block *Block) Hash(cfg *TuringchainConfig) []byte {
...
func (block *Block) GetHeader(cfg *TuringchainConfig) *Header {
	head := &Header{}
...
func VerifySignature(cfg *TuringchainConfig, block *Block, txs []*Transaction) bool {
	//检查区块的签名
...
func (block *Block) CheckSign(cfg *TuringchainConfig) bool {
	return VerifySignature(cfg, block, block.Txs)
}

func (block *Block) verifySignature(cfg *TuringchainConfig) bool {
...
func (blockDetail *BlockDetail) FilterParaTxsByTitle(cfg *TuringchainConfig, title string) *ParaTxDetail {
