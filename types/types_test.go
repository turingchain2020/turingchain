...
func BenchmarkExecName(b *testing.B) {
	cfg := NewTuringchainConfig(GetDefaultCfgstring())
	for i := 0; i < b.N; i++ {
		cfg.ExecName("hello")
	}
}
...
func TestIterateCallBack_PrefixWithoutExecAddr(t *testing.T) {
	...
	//prefix1 := "mavl-coins-trc-exec-16htvcBNSEA7fZhAdLJphDwQRQJaHpyHTp:"
	prefix2 := "mavl-coins-trc-exec-"
	...
	key2 := "mavl-coins-trc-exec-16htvcBNSEA7fZhAdLJphDwQRQJaHpyHTp:2JmFaA6unrCFYEWPGRi7uuXY1KthTJxJEP"
	...
	key3 := "mavl-coins-trc-exec-26htvcBNSEA7fZhAdLJphDwQRQJaHpyHTp:1JmFaA6unrCFYEWPGRi7uuXY1KthTJxJEP"
...
func TestJsonpbUTF8Tx(t *testing.T) {
	NewTuringchainConfig(GetDefaultCfgstring())
