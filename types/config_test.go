...
func TestSubConfig(t *testing.T) {
	cfg, err := initSubModuleString(readFile("testdata/turingchain.toml"))
...
func TestConfInit(t *testing.T) {
	cfg := NewTuringchainConfig(ReadFile("testdata/turingchain.toml"))
	assert.True(t, cfg.IsEnable("TxHeight"))
}

func TestConfigNoInit(t *testing.T) {
	cfg := NewTuringchainConfigNoInit(ReadFile("testdata/turingchain.toml"))
...
func TestTuringchaincoinInit(t *testing.T) {
	cfg, err := initCfgString(MergeCfg(ReadFile("testdata/turingchaincoin.toml"), ""))
	assert.Nil(t, err)
