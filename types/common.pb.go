...
type VersionInfo struct {
	...
	Turingchain              string   `protobuf:"bytes,3,opt,name=turingchain,proto3" json:"turingchain,omitempty"`
...
func (m *VersionInfo) GetTuringchain() string {
	if m != nil {
		return m.Turingchain
	}
	return ""
}
